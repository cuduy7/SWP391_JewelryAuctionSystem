...
const BannerIntro = () => {
  const { user, setAIListProduct, isLoading, setIsLoading } =
      ...
      >
        ...
        <p
          className="
                    ...
                    "
        >
          VBM là trang mạng xã hội về cầu lông dành cho những người đam mê thể
          thao nói chung và cầu lông nói riêng. Tại đây các bạn sẽ được gặp gỡ
          những người chơi thân thiện và hòa đồng. Hãy cùng chúng tôi phát triển
          một cộng đồng cầu lông và phát triển sức khỏe nhé.
        </p>
        <div
          className="
                        relative
